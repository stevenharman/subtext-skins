...
<div class="post">
	...
	<dl class="form">
		...
		<dt>
			<label for="Contact_ascx_tbMessage" accesskey="M" class="required"><span class="accessKey">M</span>essage</label> <asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server" ErrorMessage="Please enter a message... any message."
					ControlToValidate="tbName" Display="Static">*</asp:RequiredFieldValidator>
		</dt>
		<dd>

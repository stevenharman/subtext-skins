...
<div id="search">
	...
	<div id="search-box">
        <label for="txtSearch"></label><asp:TextBox id="txtSearch" runat="server" CssClass="searchterm" />&nbsp;<asp:Button id="btnSearch" runat="server" CssClass="searchButton" Text="Search" CausesValidation="False" />
    </div>    
